...
RECAP_INITIAL_POLICY_PATH=${RECAP_INITIAL_POLICY_PATH:-/file_system/liujincheng/Projects/verl-vla/outputs/recap/checkpoints/policy/global_step_12500/actor/huggingface}
...
RECAP_RESUME_ITERATION=${RECAP_RESUME_ITERATION:-5}
RECAP_RESUME_STEP=${RECAP_RESUME_STEP:-1}
...
overrides=(
  ...
  "recap.num_iterations=10"
  "recap.resume_iteration=$RECAP_RESUME_ITERATION"
  "recap.resume_step=$RECAP_RESUME_STEP"
  ...
  "recap.policy_eval.cluster.actor_rollout_ref.model.adapter.embodiment=libero"
  ...
  "recap.collect_data.cluster.actor_rollout_ref.model.adapter.embodiment=libero"
  ...
  "recap.collect_data.cluster.env.env_loop.max_interactions=8"
  ...
  "recap.train_value_model.trainer.save_freq=200"
  ...
  "recap.value_infer.model_path=$RECAP_VALUE_MODEL_CHECKPOINT_DIR/global_step_11600/actor/huggingface"
  ...
  "recap.train_policy.cluster.actor_rollout_ref.model.adapter.embodiment=libero"
